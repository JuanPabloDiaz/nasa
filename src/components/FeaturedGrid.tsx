...
export const FeaturedGrid: React.FC<FeaturedGridProps> = ({ className = '' }) => {
  ...
  const featuredItems = [
    {
      ...
      thumbnail: 'https://images-assets.nasa.gov/image/hubble-captures-a-galactic-waltz/hubble-captures-a-galactic-waltz~thumb.jpg',
    ...
    return (
      <div className={`${className}`}>
        <div className="text-center py-12">
          <p className="text-red-400 text-lg mb-4">Failed to load featured content</p>
          <button 
