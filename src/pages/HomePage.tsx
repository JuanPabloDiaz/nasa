      ...
      <section className="text-center py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 animate-slide-up">
            Discover breathtaking images and videos from NASA's vast collection
            of space exploration media
          </p>
      ...
      <section className="glass-card p-8 rounded-xl">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            Dive into the cosmos with NASA's incredible collection of space
            imagery and videos. From stunning Hubble telescope photographs to
            Mars rover discoveries, explore the universe through the eyes of
            humanity's greatest space exploration achievements.
          </p>
          <div className="mt-6">
            <a
